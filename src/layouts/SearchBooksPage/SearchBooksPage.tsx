...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    ...
    window.scroll(0, 0); //for every pagination i should be at top of the page
  }, [currentPage, searchUrl]); // 2nd argumnet takes array which takes state variables and every time the state variable data change the useEffect arrow function will be called
            ...
            <div className="col-4">
              <div className="dropdown">
                <button
                  ...
                  type="button"
                  id="dropdownMenuButton1" //this id and below ul aria-labelledby should be same
